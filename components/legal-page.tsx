...
// live in one place. The content of each page is real and specific to AdBrain, but is boilerplate pending a
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-4 rounded-[10px] border border-[var(--warn-ink)]/30 bg-[var(--warn-bg)] px-4 py-3 text-sm text-[var(--warn-ink)]">
          This document is a working draft under legal review. It reflects how AdBrain operates today; the final wording will be confirmed by counsel before general availability.
        </div>
