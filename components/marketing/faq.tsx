...
// true to the product: AdBrain reads accounts and recommends, it never acts; it never points at paused/ended
// entities as actions; pricing is early-access -> demo (no fabricated price).

const FAQS: { q: string; a: string }[] = [
  {
    q: "What does AdBrain do?",
    a: "AdBrain reads your Meta and Google ad accounts and tells you what to scale, refresh, or kill, with a clear reason for every call. It turns raw ad metrics into a decision you can act on.",
  },
  {
    q: "How is AdBrain different from Meta Ads Manager?",
    a: "Ads Manager shows you the numbers. AdBrain reads those numbers and gives you the decision plus the reason. It first checks whether there is enough spend behind a metric to trust it, so you do not act on a lucky or unlucky day.",
  },
  {
    q: "Does AdBrain change my ads automatically?",
    a: "No. AdBrain recommends; you decide and act. It never edits, pauses, or spends on your account by itself.",
  },
  {
    q: "Which ad platforms does AdBrain support?",
    a: "Meta (Facebook and Instagram) and Google Ads. You can view decisions for one platform or both together.",
  },
  {
    q: "How does AdBrain decide what to scale or kill?",
  ...
  {
    q: "Will AdBrain recommend acting on a paused or ended campaign?",
    a: "No. AdBrain never points you to anything paused or ended as a next action. It can, however, tell you when a paused or ended campaign was the cause of a recent drop in performance.",
  },
  {
    q: "Is my ad account data safe?",
    a: "AdBrain connects through the official Meta and Google APIs and reads your data only to analyse it. It does not post, edit, or change anything on your account.",
  },
  {
    q: "Does AdBrain work for agencies with multiple accounts?",
    a: "Yes. AdBrain works across multiple ad accounts, so an agency can see the decisions for every client in one place.",
  },
  {
    q: "How much does AdBrain cost?",
    a: "AdBrain is in early access. Book a demo and we will walk you through how it works and current pricing.",
  },
];
