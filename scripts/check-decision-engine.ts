...
const enoughConversions = decide(base({ objective: "conversion", objectiveScore: 85, roas: 6, conversions: 40, roomToScale: true, days: 14, impressions: 20000, clicks: 400 }));
...
for (const d of [refresh, scale, pause, thin, thinVolume, thinConversions, enoughConversions, thinAwareness, fewDays, manyDays]) {
