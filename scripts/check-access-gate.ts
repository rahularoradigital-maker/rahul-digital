...
const NOT_PRODUCT_GATED = new Set([
  ...
  "app/api/analytics/route.ts", // public website-analytics beacon: write-only, validated + bounded, no PII stored, RLS default-deny
  ...
  "app/api/cron/purge-deletions/route.ts", // CRON_SECRET bearer (account-deletion purge executor)
