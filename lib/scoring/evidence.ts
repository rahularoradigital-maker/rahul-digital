// Evidence tags (measurement canon doctrine rule 5: "every number carries an evidence tag").
...
// docs/engineering/measurement-canon.spec.json -> evidence_tags.
//
...
export const EVIDENCE_MEANING: Record<EvidenceTier, { name: string; meaning: string }> = {
  ...
  Y: { name: "Judgement", meaning: "Our own judgement, no public benchmark. Corrected from outcomes over time, not a platform fact." },
};
