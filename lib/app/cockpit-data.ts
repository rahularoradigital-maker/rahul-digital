...
export type CockpitData =
  | { connected: true; view: CockpitView; metrics: AccountMetrics; funnel: FunnelMetrics; accountName: string; accountId: string; dateParam: string; adsAnalyzed: number; processed: ProcessedCounts; days: number; userEmail?: string }
