...
export const EXPLICIT_DELETE_BY_USER = [
  ...
  "account_rules", // per-account automation rules (0045): user_id-scoped, no auth-user cascade, delete on account removal
  "pending_operations", // approval queue (0046): user_id-scoped, no auth-user cascade, delete on account removal
