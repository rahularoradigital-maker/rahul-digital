...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", title: TITLE, description: DESCRIPTION, url: `${SITE_URL}/integrations/meta`, siteName: "AdBrain AI" },
  twitter: { card: "summary_large_image", title: TITLE, description: DESCRIPTION },
};

// What AdBrain actually does with Meta data. Every line is a real, shipped capability (no invented metrics,
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-3xl px-6 pt-20 pb-14 text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg text-[var(--ink-muted)]">
            Connect read-only. AdBrain reads your day-wise performance and tells you what to scale, refresh, or kill, with a reason for every call.
          </p>
        ...
        <section id="how" className="mx-auto max-w-4xl px-6 py-14">
          ...
          <div className="mt-6 divide-y divide-[var(--hairline)] border-t border-[var(--hairline)]">
            {[
              { k: "Your ad account, read-only", v: "You connect through Meta's own login and grant read access to ads and insights. AdBrain can look, never touch." },
        ...
        {/* What AdBrain decides - two-column list */}
        ...
        <section className="mx-auto max-w-4xl px-6 pb-16">
          <div className="rounded-[14px] border border-[var(--hairline)] bg-[var(--surface)] p-8">
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2">
              {[
                { k: "Read access only", v: "AdBrain requests read scope for ads and insights. It cannot spend, pause, or change anything in your account." },
                ...
                { k: "Drafts, never auto-changes", v: "Every recommendation is a draft you action yourself in your ad account. AdBrain does not push edits to Meta." },
                { k: "Disconnect anytime", v: "Revoke the connection from AdBrain or from Meta, and the stored token is dropped." },
              ].map((r) => (
                <div key={r.k}>
                  <div className="text-[15px] font-medium text-[var(--ink)]">{r.k}</div>
        ...
        <section className="border-t border-[var(--hairline)]">
          <div className="mx-auto max-w-3xl px-6 py-16 text-center">
            ...
            <p className="mx-auto mt-3 max-w-lg text-[15px] text-[var(--ink-muted)]">
              AdBrain is in private access. Book a demo and we will get you set up.
            </p>
            <div className="mt-7">
              <Link href="/book-demo" className="inline-block rounded-full bg-[var(--ink)] px-7 py-3 font-medium text-white transition hover:opacity-90">
                Book a demo
